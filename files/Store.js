const data = [
  ...
  },
  {
    ...
    price: "$10.99",
    description:
      "Rose Gold Plated Double Flared Tunnel Plug Earrings. Made of 316L Stainless Steel 10 by 10 Conditon Very Beautiful and Most Perfectly.",
    category: "jewelery",
  ...
  },
  {
    ...
    price: "$39.99",
    description:
      "Lightweight perfet for trip or casual wear---Long sleeve with hooded, adjustable drawstring waist design. Button and zipper front closure raincoat, fully stripes Lined and The Raincoat has 2 side pockets.",
    category: "women's clothing",
...
for (var i = 0; i < data.length; i++) {
  var save = data[i];
  store.innerHTML += ` <div class="card d-flex justify-content-center align-items-center" style="width: 21rem; margin-top:3rem; margin-left:4rem; padding-top:2rem;">
...
<span style="font-size:20px; margin-left:6rem;"><i class="fa-solid fa-star fa-xl" style="color: #FFD43B; margin-right:1rem;"></i>${save.rating.rate}</span>
</div>
</div>`;
  function btn() {
    Swal.fire({
